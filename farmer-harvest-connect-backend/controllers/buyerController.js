...
// const getCropListingById = async (req, res) => {
//   try {
//     const listing = await CropListing.findById(req.params.id)
//       .populate('farmerId', 'name phone profile');
...
//   res.json({ message: 'makeOffer coming next' });
// };

// const getMyOffers = async (req, res) => {
//   res.json({ message: 'getMyOffers coming next' });
// };

// const initiatePurchase = async (req, res) => {
//   res.json({ message: 'purchase flow coming next' });
// };

// const uploadReceipt = async (req, res) => {
//   res.json({ message: 'upload receipt coming next' });
// };

// const getMyOrders = async (req, res) => {
//   res.json({ message: 'orders coming next' });
// };

// const getOrderById = async (req, res) => {
//   res.json({ message: 'order detail coming next' });
// };
